...
<title>Trang Phục Thu Đông - Lotusé</title>
...
<div class="category-banner">
    <h1 class="text-uppercase fw-bold m-0">Bộ Sưu Tập Thu Đông</h1>
    <p class="mt-2 opacity-75">Ấm áp và thời thượng cho những ngày se lạnh</p>
</div>
...
<div class="col-12 text-center py-5">
    ...
    <a href="TrangPhuc_Dong.php" class="btn btn-outline-dark btn-sm">Xem tất cả sản phẩm</a>
</div>
